...
public class StringUtils {
    ...
    public static final int TYPE_ACCOUNT_CONTENT_LOAD = 6;
    public static final int TYPE_ACCOUNT_CONTENT_ADD = 7;
    public static final int TYPE_COLLECT_CONTENT_LOAD = 8;
    public static final int TYPE_COLLECT_CONTENT_ADD = 9;
    public static final int TYPE_COLLECT_NO_USER = 10;
    public static final int TYPE_HOT_KEY = 11;
