...
public class StringUtils {
    ...
    public static final String OFFICIAL_CONTENT = "/wxarticle/list/";
    ...
    public static final int TYPE_ACCOUNT_TITLE = 0;
    public static final int TYPE_ACCOUNT_CONTENT_LOAD = 0;
    public static final int TYPE_ACCOUNT_CONTENT_ADD = 1;
    public static final int TYPE_COLLECT_CONTENT_LOAD = 2;
    public static final int TYPE_COLLECT_CONTENT_ADD = 5;
    public static final int TYPE_COLLECT_NO_USER = 6;
